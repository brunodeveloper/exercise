defmodule ExerciseWeb.Graphql.ContractManagerMutations do
  ...
  object :contract_mutations do
    field :create_physical_person, :physical_person_payload do
      arg(:input, non_null(:physical_person_input))
      resolve(&ContractManagerResolver.create_physical_person/3)
    end
